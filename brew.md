...
bio: a 'corporate hinge'. tinder but for coffee chats, mutually match with a student and add them to your network.

features: ai matching, info on people using linkup (reach feature)
          skill swap matching, giving eachother an ai blurb pre match to contextualize the matches -- best thing we can do is focus on people w similar goals, but different skills to offer, building off eachothers skills to partner and grow the skillest
          favorite coffee shops to minimize meetup conflict, select a cafe from one persons profile, set up meetings in house + connect to cal
          find a network based off of students skills, linkedin, projects/experiences,
          QUICK ONBOARDING
          try to get clubs they are in
