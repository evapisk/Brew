...
export async function findMatches(requestingUser) {
  ...
  try {
    ...
    if (!historyError) matchHistory = data ?? [];
  } catch (_) {
    // If RPC doesn't exist yet, proceed with empty history
  }
